...
export function ThemeToggle() {
  ...
  return (
    <div className="flex items-center space-x-1.5 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
      <Sun
      ...
      <Switch
        ...
        className="scale-90 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-105"
      />
      <Moon
        className={`h-4 w-4 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
