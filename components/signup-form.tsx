    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border-border/40 bg-gradient-to-b from-background to-muted/10 backdrop-blur">
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Become a Creator with Deinspar</CardTitle>
          <CardDescription>Create, upload, and sell your poster designs effortlessly.</CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <div className="grid gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  We handle production, shipping, and customer support. You focus on your art.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input id="fullName" placeholder="Your full name" required className="rounded-md" />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="confirmPassword" type="password" required className="rounded-md" />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="instagram" placeholder="@yourhandle" className="rounded-md" />
                </div>

                <div className="grid gap-2">
                  <Label htmlFor="portfolio">Portfolio Website</Label>
                  <Input id="portfolio" type="url" placeholder="https://yourportfolio.com" className="rounded-md" />
                </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-primary">
        By clicking Register, you agree to our <Link href="#">Terms of Service</Link> and{" "}
